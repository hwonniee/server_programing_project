		...
		<form name="frm" method="post" action="BoardServlet">
			...
			<table class="table" style="text-align:center; border: 1px solid #dddddd">
				...
				<tbody>
					<tr>
						<th>작성자</th>
						<td><input type="text" class="form-control" placeholder="작성자" name="name"> * 필수</td>
					</tr>
					<tr>
						<th>비밀번호</th>
						<td><input type="password" class="form-control" placeholder="비밀번호" name="pass">
							* 필수 (게시물 수정 삭제시 필요합니다.)
						</td>
					</tr>
					<tr>
					...
					<tr>
						<th>제목</th>
						<td><input type="text" class="form-control" placeholder="글 제목" name="title" maxlength="50">* 필수</td>
					</tr>
					<tr>
						<th>내용</th>
